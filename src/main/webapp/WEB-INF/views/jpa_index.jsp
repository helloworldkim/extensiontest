...
<!-- 확장자 체크관련 js파일-->
<script src="/jpa_index.js"></script>
<!-- 부트스트랩-->
		...
		<table>
				<tbody>
					<tr>
						...
						<td>
							<input type="checkbox" name="fileOpt" id="bat" data-extension="bat"> bat
							<input type="checkbox" name="fileOpt" id="cmd" data-extension="cmd"> cmd 
							<input type="checkbox" name="fileOpt" id="com" data-extension="com"> com 
							<input type="checkbox" name="fileOpt" id="cpl" data-extension="cpl"> cpl 
							<input type="checkbox" name="fileOpt" id="exe" data-extension="exe"> exe 
							<input type="checkbox" name="fileOpt" id="scr" data-extension="scr"> scr
							<input type="checkbox" name="fileOpt" id="js" data-extension="js"> js
						</td>
					</tr>
					<tr>
